<section class="elementor-section elementor-top-section elementor-element elementor-element-c53457c elementor-section-full_width elementor-section-height-default elementor-section-height-default rt-parallax-bg-no" data-id="c53457c" data-element_type="section" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
						<div class="elementor-container elementor-column-gap-default">
					<div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-b6ee56a" data-id="b6ee56a" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
								<div class="elementor-element elementor-element-da0d8c4 elementor-align-center elementor-widget elementor-widget-rt-title" data-id="da0d8c4" data-element_type="widget" data-widget_type="rt-title.default">
				<div class="elementor-widget-container">
			<div class="section-heading">
	        <div class="heading-subtitle">Our Latest Listing</div>
    <h2 class="heading-title">New Listings in Our Directory</h2>
<p>Lorem Ipsum is simply dummying text of the printing and typesetting industry.</p>    </div>		</div>
				</div>
				<div class="elementor-element elementor-element-9b34756 elementor-invisible elementor-widget elementor-widget-rt-listings" data-id="9b34756" data-element_type="widget" data-settings="{&quot;_animation&quot;:&quot;fadeInUp&quot;}" data-widget_type="rt-listings.default">
				<div class="elementor-widget-container">
			<div class="rtcl section-1500">
  <div class="row row-cols-xl-2 row-cols-lg-1 row-cols-1 gutter-enable listing-shortcode listing-list-shortcode rtcl-list-view">
      

<?php for($i=1;$i<=4;$i++){?>

    <div class="col ">
      <div class="product-box listygo-rating  db-metalist db-countdown">
        <div class="item-img bg--gradient-50">
    <div class="rt-categories">
                <a href="#" class="category-list">
            <span class="rtcl-cat-icon rtcl-icon rtcl-icon- demo-icon listygo-rt-icon-r-cat8"></span>            &nbsp;Italian        </a>
                <div class="rtcl-listing-badge-wrap"></div>
    </div>
    
   
    <div class="listing-thumb">
        <a href="<?php echo base_url();?>classified/detail" class="rtcl-media grid-view-img"><img decoding="async" width="370" height="240" src="<?php echo $uploads;?>classified-listing/2022/11/r-5-min-370x240.jpg" class="rtcl-thumbnail" alt="r-5-min" title=""></a>
        <a href="<?php echo base_url();?>classified/detail" class="rtcl-media list-view-img"><img decoding="async" width="350" height="270" src="<?php echo $uploads;?>classified-listing/2022/11/r-5-min-350x270.jpg" class="rtcl-thumbnail" alt="r-5-min" title=""></a>
	</div>
        <div class="directory-block__poster">
            <div class="directory-block__poster__thumb">
              <a class="directory-block__poster__link--image" href="#">
          <img width="40" height="40" src="<?php echo $uploads;?>classified-listing/2022/08/user4-2-150x150.jpg" class="attachment-40x40 size-40x40" alt="" decoding="async" title="">        </a>
              </div>
...
<h3 class="listing-title rtcl-listing-title"><a href="<?php echo base_url();?>classified/detail">The shapes of pasta food</a></h3>            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit egestas id gravida.</p>
...
<svg width="14" height="16" viewbox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		</svg>The Square Plaza, NJ, USA</li>
      <li class="meta-phone"><a href="tel:012548963"><svg width="16" height="16" viewbox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<ul class="meta-item">
    <li class="meta-price">
    <div class="rtcl-price price-type-fixed"><span class="rtcl-price-amount amount"><bdi><span class="rtcl-price-currencySymbol">&#36;</span>250</bdi></span></div>  </li>
    <li class="entry-meta">
    <ul>
