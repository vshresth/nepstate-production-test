...
$jobs = get_category_title('jobs');
$eventsTitle = get_category_title('events');
$services = get_category_title('services');
$itTrainers = get_category_title('it-trainings');
$roomAndRent = get_category_title('roomates-rentals');
        ...
        <div class="scrollable">
            ...
            <ul class="scrollable__content py-2">
                ...
                <ul>
                            ...
                            <ul class="menu__sub">
                                <li>
                                    <a href="{{ url('/show-classifer-Events') }}"
                                        ...
                                        <div class="menu__title"><?php echo $eventsTitle; ?></div>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ url('/show-classifer-IT_Training') }}"
                                        ...
                                        <div class="menu__icon"> <i data-lucide="corner-down-right"></i> </div>
                                        <div class="menu__title"><?php echo $itTrainers; ?></div>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ url('/show-classifer-Jobs') }}"
                                        ...
                                        <div class="menu__icon"> <i data-lucide="corner-down-right"></i> </div>
                                        <div class="menu__title"><?php echo $jobs; ?></div>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ url('/show-classifer-Roomates&Rental') }}"
                                        ...
                                        <div class="menu__icon"> <i data-lucide="corner-down-right"></i> </div>
                                        <div class="menu__title">  <?php echo $roomAndRent; ?> </div>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ url('/show-classifer-Services') }}"
                                        ...
                                        <div class="menu__icon"> <i data-lucide="corner-down-right"></i> </div>
                                        <div class="menu__title"><?php echo $services; ?></div>
                                    </a>
                                </li>
                            </ul>
                        </li>
                    ...
                    @endif
                    @if (session('role') == 'admin' || in_array('Blogs_Request', $userPermissions))
                        <li>
                            <a href="{{ url('/all-approval') }}"
                                class="menu {{ Str::startsWith(Request::url(), url('/all-approval')) ? 'side-menu--active' : '' }}">
                                <div class="menu__icon"> <i data-lucide="check"></i> </div>
                                <div class="menu__title"> Blogs Requests</div>
                            </a>
                        </li>
                    @endif
                    ...
                    @endif
                    @if (session('role') == 'admin' || in_array('Reviews', $userPermissions))
                        <li>
                            <a href="{{ url('/all-reviews') }}"
                                class="menu {{ Request::is('all-reviews*') ? 'side-menu--active' : '' }}">
                                <div class="menu__icon"> <i data-lucide="message-square"></i> </div>
    ...
    <div
        ...
        <div class="h-full flex items-center">
            ...
            @if (session('role') == 'admin' || in_array('Notifications', $userPermissions))
                ...
                @php
                    $unreadNotifications = $notifications->where('notification_for', 'admin')->where('seen', 0);
        ...
        <nav class="side-nav">
            ...
            <ul>
                        ...
                        <ul class="side-menu__sub">
                            <li>
                                <a href="{{ url('/show-classifer-Events') }}"
                                    ...
                                    <div class="side-menu__title"> <?php echo $eventsTitle; ?> </div>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/show-classifer-IT_Training') }}"
                                    ...
                                    <div class="side-menu__icon"> <i data-lucide="corner-down-right"></i> </div>
                                    <div class="side-menu__title">  <?php echo $itTrainers; ?></div>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/show-classifer-Jobs') }}"
                                    ...
                                    <div class="side-menu__icon"> <i data-lucide="corner-down-right"></i> </div>
                                    <div class="side-menu__title">  <?php echo $jobs; ?></div>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/show-classifer-Roomates&Rental') }}"
                                    ...
                                    <div class="side-menu__icon"> <i data-lucide="corner-down-right"></i> </div>
                                    <div class="side-menu__title">  <?php echo $roomAndRent; ?></div>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/show-classifer-Services') }}"
                                    ...
                                    <div class="side-menu__icon"> <i data-lucide="corner-down-right"></i> </div>
                                    <div class="side-menu__title">  <?php echo $services; ?> </div>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                @if (session('role') == 'admin' || in_array('Blogs_Request', $userPermissions))
                    <li>
                        <a href="{{ url('/all-approval') }}"
                            class="side-menu {{ Str::startsWith(Request::url(), url('/all-approval')) ? 'side-menu--active' : '' }}">
                            <div class="side-menu__icon"> <i data-lucide="check"></i> </div>
                            <div class="side-menu__title">  Blogs Requests </div>
                        </a>
                    </li>
                @endif
                @if (session('role') == 'admin' || in_array('FAQS', $userPermissions))
                ...
                @if (session('role') == 'admin' || in_array('Reviews', $userPermissions))
                    <li>
                        <a href="{{ url('/all-reviews') }}"
                            class="side-menu {{ Request::is('all-reviews*') ? 'side-menu--active' : '' }}">
                            {{-- <a href="/admin-countries" class="side-menu side-menu--active"> --}}
                            <div class="side-menu__icon"> <i data-lucide="message-square"></i> </div>
                            <div class="side-menu__title"> All Reviews </div>
                        </a>
                    </li>
                @endif
                @if (session('role') == 'admin' || in_array('Coupons', $userPermissions))
