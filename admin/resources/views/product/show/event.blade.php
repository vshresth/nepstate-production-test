        ...
        <div class="grid col-span-4 gap-3 lg:col-span-4 2xl:col-span-3">
            <div class="box p-5 rounded-md">
                <div
                    ...
                    <a href="{{ url('/show-classifer-Events') }}?country_id={{ request('country_id') }}&status={{ request('status') }}" class="text-primary hover:text-primary-dark ml-auto">Go
                        Back</a>
                </div>
