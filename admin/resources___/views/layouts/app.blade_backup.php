            ...
            <ul class="scrollable__content py-2">
                ...
                <ul>
                    ...
                    @if (session('role') == 'admin' || in_array('Advertisment', $userPermissions))
                        <li> <a href="{{ url('/product-ads') }}"
                                class="menu {{ Str::startsWith(Request::url(), url('/product-ads')) || Str::startsWith(Request::url(), url('/ad-create')) ? 'side-menu--active' : '' }}">
    ...
    <div class="flex overflow-hidden">
        ...
        <nav class="side-nav">
            ...
            <ul>
                ...
                @if (session('role') == 'admin' || in_array('Advertisment', $userPermissions))
                    <li> <a href="{{ url('/product-ads') }}"
                            class="side-menu {{ Str::startsWith(Request::url(), url('/product-ads')) || Str::startsWith(Request::url(), url('/ad-create')) ? 'side-menu--active' : '' }}">
