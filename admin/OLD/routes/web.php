...
Route::middleware(['isLoggedIn'])->group(function () {
    ...
    Route::get('/show-classifer-Events', [ProductController::class, 'events']);
    Route::get('/show-classifer-IT_Training', [ProductController::class, 'trainings']);
    Route::get('/show-classifer-Jobs', [ProductController::class, 'jobs']);
    Route::get('/show-classifer-Roomates&Rental', [ProductController::class, 'rentals']);
    Route::get('/show-classifer-Services', [ProductController::class, 'services']);
