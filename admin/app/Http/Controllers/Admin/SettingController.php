...
class SettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $validatedData['no_of_lists'] = $request->input('no_of_lists');
        $validatedData['happy_customers'] = $request->input('happy_customers');
        $validatedData['visitors'] = $request->input('visitors');
