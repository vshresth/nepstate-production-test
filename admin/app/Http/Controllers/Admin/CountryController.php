...
class CountryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $country->services_fee = $validatedData['services_fee'];
        if(isset($request->fee_status)) {

            $country->fee_status = $request->fee_status;
        }
        $country->save();
    ...
    public function showProductsAdsPage()
{
    $countries = Countries::all(); 
    return view('layouts.app', compact('countries'));
}
