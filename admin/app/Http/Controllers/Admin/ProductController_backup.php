...
class ProductController extends Controller
{
    public function events(Request $request)
    {
        ...
        // Fetch events based on the selected country
        $events = Products::when($selectedCountryId, function ($query, $countryId) {
            return $query->where('country_id', $countryId);
        })->where('category', 'events')
          ->with('country') // Ensure we include the country relationship
          ->get();
