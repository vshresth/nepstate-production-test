    ...
    <div class="col-md-12 rtcl-login-form-wrap">
        ...
        <form id="rtcl-login-form" class="form-horizontal" method="post" action="">
            <div class="form-group">
                ...
                <input type="password" name="password" autocomplete="New Password" value="" id="rtcl-user-login" class="form-control" required>
            </div>
            <div class="form-group">
                <label for="rtcl-user-login" class="control-label">
                    Confirm New password                   <strong class="rtcl-required">*</strong>
                </label>
                <input type="password" name="cpassword" autocomplete="Confirm New Password" value="" id="rtcl-user-login" class="form-control" required>
            </div>
