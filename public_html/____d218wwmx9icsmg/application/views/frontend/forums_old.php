      ...
      <div class="row justify-content-center gutters-40"  style="margin: 0 15px;">
         <div class="col-lg-12 order-lg-1">
          <div class="rtcl-listings-actions">
                  ...
                  <select name="orderby" class="orderby" aria-label="Forum order" onchange="do_show_order_by_sort(this.value)" style="width:25%">
         ...
         <div class="col-lg-8 order-lg-1">
            ...
            if(empty($blogs)){
                  echo "<div class='no_blog'>
                        No forum Found! Be the first one to post a forum!
                  </div>";
               }
            ?>
            <div class="row row-cols-1 row-cols-lg-1 row-cols-md-1">
               ...
               ?>
                  <div class="col" onclick="window.location.href='<?php echo base_url();?>forum/details/<?php echo $blog->slug;?>'" style="cursor: pointer;">
                     <article id="post-3732" class="blog-box-layout1 blog-list  post-3732 post type-post status-publish format-standard has-post-thumbnail hentry category-travel tag-cafe tag-travel have-post-thumb">
                        ...
                        <div class="post-content">
                           ...
                           <h3 class="post-title" style="margin-top:18px"><a href="<?php echo base_url();?>forum/details/<?php echo $blog->slug;?>"><?php echo $blog->title;?></a></h3>
                           <div class="content">
                              <p><?php 
                              $tags_strip = strip_tags($blog->description);
                              echo substr($tags_strip,0,200)."...";?></p>
                           </div>
                           <div class="btn-wrap btn-v2">
                              <a href="<?php echo base_url();?>forum/details/<?php echo $blog->slug;?>" class="item-btn">
                        ...
                        <div class="row registration-disable registration-not-separate" id="rtcl-user-login-wrapper">
                           <div class="wd100">
                              ...
                              <div class="button_blog">
                                  <button onclick="close_popup()" class="ff-btn ff-btn-submit ff-btn-md  ff_btn_no_style btn ">I'll do it later</button>
                                      <a href="<?php echo base_url();?>post-forum" class="ff-btn ff-btn-submit ff-btn-md item-btn ff_btn_no_style btn btn-primary wd60">Post Your Forum</a>
                                  </a>
                              </div>
                           </div>
                        </div>
