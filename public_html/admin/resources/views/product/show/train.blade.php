...
@section('content')
    ...
    <div class="intro-y block sm:flex items-center h-10">
        ...
        {{  get_category_title('it-trainings') }}
        </h2>
        ...
        <div class="grid col-span-4 gap-3 lg:col-span-4 2xl:col-span-3">
            <div class="box p-5 rounded-md">
                <div
                    ...
                    <a href="{{ url('/show-classifer-IT_Training') }}?country_id={{ request('country_id') }}&status={{ request('status') }}" class="text-primary hover:text-primary-dark ml-auto">Go
                        Back</a>
                </div>
