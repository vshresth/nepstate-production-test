...
@section('content')
    <br>
    <form method="POST" action="{{ route('users.storeAndAuthenticate') }}" enctype="multipart/form-data">
        @csrf
                        ...
                        <div class="col-md-6">
                            ...
                            {{-- <div class="form-group">
                                ...
                                <input type="text" name="phone" id="phone" class="form-control"
                                    value="{{ old('phone') }}" placeholder="Enter your phone number (e.g., 1234567890)">
                                @error('phone')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div> --}}
