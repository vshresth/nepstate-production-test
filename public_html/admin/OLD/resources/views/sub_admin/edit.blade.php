        ...
        <div class="intro-y col-span-12 lg:col-span-6">
            <div class="intro-y box">
                ...
                <div id="input" class="p-5">
                    ...
                    $permissionList = ['Dashboard', 'Users', 'Countries', 'Classified Categories', 'Classified', 'Advertisment', 'Payment Plans', 'Forum', 'Confession', 'Blogs', 'FAQS', 'Static Page', 'Testimonials', 'Google Ads', 'All Comments', 'Coupons', 'Notifications', 'Settings'];
                    $permissionValue = ['Dashboard', 'Users', 'Countries', 'Classified_Categories', 'Classified', 'Advertisment', 'Payment_Plans', 'Forum', 'Confession', 'Blogs', 'FAQS', 'Static_Page', 'Testimonials', 'Google_Ads', 'All_Comments', 'Coupons', 'Notifications', 'Settings'];
